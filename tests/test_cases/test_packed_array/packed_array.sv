...
// A nested packed struct element type (NoC-header shaped).
...
module packed_array (
    ...
    // Packed arrays used to exercise the integer/binary-string write boundary.
